...
https://nuxt-hybrid-tailwind-20260610-15454.vercel.app/

目前這個 production URL 連到 `main` 分支部署。最新的 ProjectionLab-style 首頁改版目前在 `dev` 分支，且專案已設定 `dev` 不自動觸發 Vercel 部署；合併並推送到 `main` 後，production URL 才會顯示最新首頁。
